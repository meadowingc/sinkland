...
pub static NAME_DATA: Lazy<NameData> = Lazy::new(|| NameData {
    first_names: vec![
        ...
        "Sage", "River", "Phoenix", "Rowan", "Blake", "Drew", "Emery", "Finley",
        "Harper", "Hayden", "Jamie", "Jessie", "Kai", "Kennedy", "Lane", "Logan",
        "Mackenzie", "Madison", "Misha", "Nico", "Parker", "Peyton", "Reese", "Remy",
        "Sam", "Shannon", "Skyler", "Spencer", "Sydney", "Terry", "Toni", "Val",
        "Winter", "Wren", "Ash", "Bay", "Blue", "Brook", "Cedar", "Cloud",
        "Cyan", "Dawn", "Echo", "Eden", "Ember", "Fern", "Frost", "Gray",
        "Haven", "Indigo", "Ivy", "Jade", "Lake", "Leaf", "Luna", "Maple",
        "Meadow", "Mist", "Moon", "Moss", "Oak", "Ocean", "Olive", "Onyx",
        "Rain", "Reed", "Robin", "Rose", "Ruby", "Sage", "Shade", "Silver",
        "Sky", "Snow", "Star", "Stone", "Storm", "Summer", "Sunny", "Terra",
        "Violet", "Willow", "Zephyr", "Zen", "Nova", "Coral", "Dune", "Fable",
    ],
    adjectives: vec![
        "silent", "cosmic", "dreamy", "wild", "gentle", "bright", "dark", "soft",
        "swift", "calm", "bold", "shy", "wise", "free", "warm", "cool",
        "happy", "lost", "found", "quiet", "loud", "small", "vast", "deep",
        "light", "heavy", "sweet", "sharp", "smooth", "rough", "clear", "misty",
        "sunny", "rainy", "stormy", "cloudy", "starry", "golden", "silver", "bronze",
        "crystal", "velvet", "satin", "marble", "wooden", "mossy", "dusty", "rusty",
        "ancient", "modern", "future", "eternal", "fleeting", "endless", "hidden", "open",
        "sacred", "magic", "mystic", "wonder", "curious", "clever", "witty", "noble",
        "humble", "proud", "fierce", "tender", "bitter", "mellow", "vivid", "faded",
        "neon", "pastel", "shadow", "lunar", "solar", "astral", "primal", "urban",
    ],
    nouns: vec![
        "moon", "sun", "star", "cloud", "rain", "storm", "wind", "snow",
        "river", "ocean", "lake", "stream", "wave", "tide", "shore", "beach",
        "mountain", "valley", "forest", "meadow", "garden", "field", "path", "road",
        "bridge", "tower", "castle", "house", "door", "window", "mirror", "shadow",
        "light", "flame", "ember", "spark", "ash", "dust", "sand", "stone",
        "crystal", "gem", "pearl", "gold", "silver", "iron", "copper", "bronze",
        "leaf", "flower", "tree", "root", "branch", "seed", "bloom", "thorn",
        "bird", "wolf", "fox", "deer", "owl", "raven", "dove", "swan",
        "cat", "lion", "tiger", "bear", "whale", "dolphin", "fish", "shark",
        "dragon", "phoenix", "griffin", "unicorn", "spirit", "ghost", "soul", "heart",
        "mind", "dream", "thought", "wish", "hope", "fear", "love", "song",
        "poem", "story", "myth", "legend", "echo", "whisper", "voice", "word",
        "writer", "artist", "dancer", "singer", "poet", "dreamer", "seeker", "wanderer",
    ],
});
